...
---
# Documentatie-eigendom (orthodox-ronl)
...
| **D4 — terminologie**    | [terminologie.md](terminologie.md) §0 (R1–R5) geldt overal; zie ook `.cursor/rules/orthodox-ronl-terminologie.mdc`. |

---

## Cursor-regel (alle org-repo's)

Elke repository onder `github.com/orthodox-ronl` hoort het bestand `.cursor/rules/orthodox-ronl-terminologie.mdc` **in git** te hebben (zelfde inhoud).
