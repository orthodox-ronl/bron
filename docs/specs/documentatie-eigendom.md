...
| Org-contracten conversie/export (wat/wanneer)                  | **`bron`**               | [conversiemechanismen](../reference/conversiemechanismen.md), [exportcontracten](../reference/exportcontracten.md), exporttype-/conversie-pagina's                                                         |
| Tool-specifiek (VSA), incl. CLI man-pages en Hugo-build        | **VSA-tooling**          | VSA-syntax, parser, SVG-rendering, Hugo-build, [`vsa` CLI-referentie](https://github.com/orthodox-groningen/VSA-tooling/blob/main/docs/reference/cli/index.md)                                             |
