...
| [Catalogus-architectuur](catalogus-architectuur.md)                                              | Hoe de alias-index en resolver samenhangen (fase 2).                                                                 |
| [Catalogus — zoek-API](catalogus-zoek-api.md)                                                    | Wat `catalogus.zoek` / `zoek_kandidaten` betekenen voor zoekers en tooling.                                          |
| [Catalogus — zangstuk in samenstelling-sjablonen](catalogus-samenstelling-zangstuk.md)           | Het `zoek:`-contract in markdown-sjablonen voor [samenstellingen](@).                                                |
