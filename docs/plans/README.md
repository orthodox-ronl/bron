...
| [TEv2 H5 — meerwoordige TermRefs](tev2-h5-meerwoordige-termrefs.md)           | Meerwoordige terms, synoniemen, tekstvereenvoudiging (H5).             |
| [TEv2 H6 — docs-toolchain](tev2-h6-toolchain.md)                              | Script-parity, serve≈CI, contributor-docs, versie-pins.                |
| [TEv2 — bredere TermRef-campagne](tev2-termref-campagne.md)                   | Later: TermRefs systematisch op specs/reference/history (gepland).     |
| [Docs-content: publiek & paginatypen](docs-content-publiek-en-paginatypen.md) | Voorstel: persona’s, paginatypen, audit en werkplan inhoud.            |
